...
const TIERS: Tier[] = [
  ...
  },
  {
    ...
    features: [
      "Everything in Codex Key",
      "Signal Ink — questions to the author",
      "Author Whisper layer in margins",
  ...
  },
  {
    ...
    price: "$24",
    period: "/month",
    tagline: "See how others read.",
    features: [
      "Everything in Author Sub",
      "Community Margin layer",
      "All reader annotations visible",
      "Archive Ink — permanent marks",
    ],
  ...
  },
  {
    ...
    price: "$50",
    period: "/month",
    tagline: "You are part of the book.",
    features: [
      "Everything in Subject Archive",
      "Signed physical edition",
      "Name in the dedication",
      "Private reading with the author",
    ],
